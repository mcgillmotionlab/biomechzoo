...
% - Step 9 (The statistical analysis section) demonstrates how to export data to be reading
...
% - sample_study are also mass normalized, renamed, and coordinate transformed in order to
...
% - sample_study are partitionned based on right limb force plate hits
